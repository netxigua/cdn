...
$('.search-show').bind('click', function(){
    $(this).find('.fas').toggleClass('fa-window-close')
 ...
 **/
 jQuery(document).ready(function() {
	jQuery('#article-index span').on('click', function() {
		if (jQuery('#article-index span').html() == '[显示]') {
			jQuery('#article-index span').html('[隐藏]')
		} else {
			jQuery('#article-index span').html('[显示]')
		}
		jQuery('#article-index ul').toggle();
		jQuery('#article-index small').toggle()
	})
});
